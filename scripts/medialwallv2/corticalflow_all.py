...
proj_gt_path = os.path.join(project_gt_base_path, subject_id, f'{hemi}_{surfType}.stl')
...
#212419_lh_pial_Df2.pial
pred_path = os.path.join(project_pred_base_path,subject_id,
                        f'{subject_id}_{hemi}_{surfType}_Df2.{surfType}.stl')
pred_path_fs = os.path.join(project_pred_base_path,subject_id,
                        f'{subject_id}_{hemi}_{surfType}_Df2.{surfType}')
