...
file_path = "/home/users/washbee1/mwexperiments/201818/surf/rh.white.stl"
bash_command = "mris_convert /home/users/washbee1/mwexperiments/201818/surf/rh.white /home/users/washbee1/mwexperiments/201818/surf/rh.white.stl"
...
source_mesh = pv.read('/data/users2/washbee/speedrun/deepcsr-preprocessed/201818/rh_white.stl')#transformed ground truth
save_mesh(source_mesh,"B.stl",'stl')

target_mesh = pv.read('/home/users/washbee1/mwexperiments/201818/surf/rh.white.stl')#Freesurfer
...
third_mesh = pv.read('/data/users2/washbee/speedrun/outputdirs/deepcsr-output_dir/checkpoints/predict_debug/201818_rh_white.stl')
...
meshA = pv.read('/data/users2/washbee/speedrun/outputdirs/deepcsr-output_dir/checkpoints/predict_debug/201818_rh_white.stl')  # Replace with the path to your mesh file

file_path = "/home/users/washbee1/mwexperiments/201818/surf/rh.white.medial_wall.ply"

# Check if the file exists
if not os.path.exists(file_path):
    createMedialWallPly(file_path)

medial_wall = pv.read('/home/users/washbee1/mwexperiments/201818/surf/rh.white.medial_wall.ply')
