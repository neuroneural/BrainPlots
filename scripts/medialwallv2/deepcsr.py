...
source_mesh = pv.read('/data/users2/washbee/speedrun/deepcsr-preprocessed/201818/lh_pial.stl')

target_mesh = pv.read('/home/users/washbee1/mwexperiments/201818/surf/lh.pial.stl')
...
third_mesh = pv.read('/data/users2/washbee/speedrun/outputdirs/deepcsr-output_dir/checkpoints/predict_debug/201818_lh_pial.stl')
