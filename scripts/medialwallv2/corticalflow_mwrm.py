...
ply_path = os.path.join(subjects_dir, 'surf', 'lh.medial_wall.ply')
stl_path = os.path.join('/data/users2/washbee/speedrun/corticalflow_fork/output2/corticalflow_euler_neurips/out_lh_pial/201818',
                        '201818_lh_pial_Df2.pial.stl')
output_path = os.path.join('/data/users2/washbee/speedrun/corticalflow_fork/output2/corticalflow_euler_neurips/out_lh_pial/201818',
                        '201818_lh_pial_Df2.pial.modified.stl')

# Load medial wall points from PLY file
medial_wall_points = load_ply_points(ply_path)
