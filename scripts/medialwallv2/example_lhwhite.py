...
fs_white_path = os.path.join(subjects_dir, subject_id, 'surf', f'{hemi}.white.stl')

pial_fnames = {
    "deepcsr": "/data/users2/washbee/speedrun/outputdirs/deepcsr-output_dir-timing/checkpoints/test-set/201818_lh_white.stl",
    # "pialnn": "/data/users2/washbee/speedrun/PialNN_fork/ckpts/eval_subj_id/pialnn_mesh_eval_lh_subject_201818.obj",
    "cortexode": "/data/users2/washbee/speedrun/CortexODE_fork/ckpts/reviewpapertest/adni_lh_201818.white.stl",#adni worked best hcp didn't work. 
    "vox2cortex": "/data/users2/washbee/speedrun/Vox2Cortex_fork/experiments/hcp/test_template_42016_DATASET_NAME/meshes/lh_white/201818_epoch76_struc0_meshpred.ply",
    "topofit": "/data/users2/washbee/speedrun/topofit-data/201818/surf/lh.white.topofit.stl",
    "freesurfer": fs_white_path
}

mwall_points = '/data/users2/washbee/speedrun/mwexperiments/201818/surf/lh.white.medial_wall.pkl'
